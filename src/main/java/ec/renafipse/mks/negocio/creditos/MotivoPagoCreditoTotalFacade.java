 ...
 */
@Stateless
public class MotivoPagoCreditoTotalFacade extends AbstractFacade<MotivoPagoCreditoTotal> {
    ...
    public MotivoPagoCreditoTotalFacade() {
        super(MotivoPagoCreditoTotal.class);
    }
