 ...
 */
@Embeddable
public class SaldosCajaPK implements Serializable {
    ...
    public SaldosCajaPK(long codigoApertura, long codigoMoneda) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SaldosCajaPK)) {
            return false;
        }
        SaldosCajaPK other = (SaldosCajaPK) object;
    ...
    public String toString() {
        return "ec.renafipse.mks.modelo.cajas.SaldosCajaPK[ codigoApertura=" + codigoApertura + ", codigoMoneda=" + codigoMoneda + " ]";
    }
