 ...
 */
@Embeddable
public class RolOpcionOpePorDefPK implements Serializable {
    ...
    public RolOpcionOpePorDefPK() {
    }

    public RolOpcionOpePorDefPK(String codigoRol, long codigoOperacion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RolOpcionOpePorDefPK)) {
            return false;
        }
        RolOpcionOpePorDefPK other = (RolOpcionOpePorDefPK) object;
    ...
    public String toString() {
        return "ec.renafipse.mks.modelo.seguridades.RolOpcionOpePorDefPK[ codigoRol=" + codigoRol + ", codigoOperacion=" + codigoOperacion + " ]";
    }
