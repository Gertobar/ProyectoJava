 ...
 * @author vastudillo
 */
@ManagedBean(name = "reporteIngresosEgresosCajaBean")
@ViewScoped
public class ReporteIngresosEgresosCajaBean extends AbstractController<IngresoEgresoCaja> implements Serializable {
    ...
    public ReporteIngresosEgresosCajaBean() {
     ...
     */
    public void imprimeTxt(ActionEvent actionEvent) throws JRException, IOException, ClassNotFoundException {

        if (apertura == null) {
            MuestraMensaje.addAdvertencia(ResourceBundle.getBundle("/propiedadesMensajesEC").getString("SeleccioneApertura"));
            return;
        }
        String nombreReporte = "ingresosEgresosCaja";
        ...
        getGeneraReporte().exporta("/financiero/reportes/ingresosEgresosCaja/reporte/", nombreReporte,
                nombreReporte+ String.valueOf(this.apertura.getCodigo()) + ".txt",
    ...
    public void exportaExcel(ActionEvent actionEvent) throws JRException, IOException, ClassNotFoundException {
       ...
       if (apertura == null) {
        ...
        getGeneraReporte().exporta("/financiero/reportes/ingresosEgresosCaja/reporte/", nombreReporte,
                nombreReporte + String.valueOf(this.apertura.getCodigo()) + ".xls",
