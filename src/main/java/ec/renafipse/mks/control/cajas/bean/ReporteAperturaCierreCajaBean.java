 ...
 * @author vastudillo
 */
@ManagedBean(name = "reporteAperturaCierreCajaBean")
@ViewScoped
public class ReporteAperturaCierreCajaBean extends AbstractController<AperturaCajaMovimientoCta> implements Serializable {
    ...
    public ReporteAperturaCierreCajaBean() {
    ...
    public void imprimePdf(ActionEvent actionEvent) throws JRException, IOException, ClassNotFoundException {
        ...
        getGeneraReporte().exporta("/financiero/reportes/movimientosCuenta/reporte/", nombreReporte,
                "movimientosCuenta" + String.valueOf(this.apertura.getCodigo()) + ".pdf",
    ...
    public void imprimeApertura(ActionEvent actionEvent) {
        try {
            ...
            getGeneraReporte().exporta("/financiero/cajas/apertura/reporte/", nombreReporte,
                    "aperturaCaja" + this.apertura.getCodigo() + ".pdf",
                    "PDF", externalContext, facesContext);
        } catch (Exception e) {
        }
    }
