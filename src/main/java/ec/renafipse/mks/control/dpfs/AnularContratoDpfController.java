...
@ViewScoped
public class AnularContratoDpfController extends AbstractController<ContratoDpf> {
        ...
        if (ActivacionUsuario.getCodigoComputador() == null) {
            ...
            try {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, CapturaError.errorNoCapturadoCapaDeControl,
                    new Object[]{"anularContratoDpfController", "init", CapturaError.getErrorException(ex)});
            }
        } else {
    ...
    public AnularContratoDpfController() {
