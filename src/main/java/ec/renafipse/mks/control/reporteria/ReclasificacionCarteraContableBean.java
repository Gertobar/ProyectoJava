...
@ManagedBean(name = "reclasificacionCarteraContableBean")
@ViewScoped
public class ReclasificacionCarteraContableBean extends AbstractController<Comprobante> implements Serializable {
    ...
    public void imprime(Long codIfip, String periodo,Date fecInicio,Date fecFin, String extension, String tipo) throws JRException, IOException, ClassNotFoundException {
        ...
        nombreReporte = "reclasificacionCartera";
        ...
        String ruta=externalContext.getRealPath("/reporteria/contable/reclasificacionCartera/reporte/"+nombreReporte+".jasper");
        ruta=ruta.substring(0, ruta.lastIndexOf(nombreReporte));
        getGeneraReporte().getParametros().put("SUBREPORT_DIR", ruta);

        getGeneraReporte().exporta("/reporteria/contable/reclasificacionCartera/reporte/", nombreReporte,
