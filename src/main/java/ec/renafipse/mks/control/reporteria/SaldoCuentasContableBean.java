...
@ManagedBean(name = "saldoCuentasBean")
@ViewScoped
public class SaldoCuentasContableBean extends AbstractController<Comprobante> implements Serializable {
    ...
    public void imprime(Long codIfip, String periodo,Date fecInicio,Date fecFin, String extension, String tipo) throws JRException, IOException, ClassNotFoundException {
        ...
        String ruta=externalContext.getRealPath("/reporteria/contable/saldosCuentas/reporte/"+nombreReporte+".jasper");
        ruta=ruta.substring(0, ruta.lastIndexOf(nombreReporte));
        getGeneraReporte().getParametros().put("SUBREPORT_DIR", ruta);

        getGeneraReporte().exporta("//reporteria/contable/saldosCuentas/reporte/", nombreReporte,
