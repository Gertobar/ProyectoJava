...
@ManagedBean(name = "cuadreContablesBean")
@ViewScoped
public class CuadreContablesBean extends AbstractController<Comprobante> implements Serializable {
