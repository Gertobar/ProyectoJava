...
@ManagedBean(name = "reclasificacionDPFSContableBean")
@ViewScoped
public class ReclasificacionDPFSContableBean extends AbstractController<Comprobante> implements Serializable {
    ...
    public void imprime(Long codIfip, String periodo,Date fecInicio,Date fecFin, String extension, String tipo) throws JRException, IOException, ClassNotFoundException {
        ...
        String ruta=externalContext.getRealPath("/reporteria/contable/saldosDpfs/reporte/"+nombreReporte+".jasper");
        ruta=ruta.substring(0, ruta.lastIndexOf(nombreReporte));
        getGeneraReporte().getParametros().put("SUBREPORT_DIR", ruta);

        getGeneraReporte().exporta("/reporteria/contable/saldosDpfs/reporte/", nombreReporte,
