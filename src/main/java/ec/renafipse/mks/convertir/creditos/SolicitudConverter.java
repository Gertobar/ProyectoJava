...
public class SolicitudConverter implements Converter {
    ...
    ec.renafipse.mks.modelo.creditos.SolicitudPK getKey(String value) {
        ec.renafipse.mks.modelo.creditos.SolicitudPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new ec.renafipse.mks.modelo.creditos.SolicitudPK();
        key.setNumero(Long.parseLong(values[0]));
        key.setCodigoIfip(Long.parseLong(values[1]));
        return key;
    }

    String getStringKey(ec.renafipse.mks.modelo.creditos.SolicitudPK value) {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Solicitud) {
            ...
            return getStringKey(o.getSolicitudPK());
        } else {
