...
@ManagedBean
public class GuiaDepositoChequeDesConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof GuiaDepositoChequeDes) {
            GuiaDepositoChequeDes o = (GuiaDepositoChequeDes) object;
            return getStringKey(o.getCodigoCheque());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), GuiaDepositoChequeDes.class.getName()});
            return null;
        }
    }
