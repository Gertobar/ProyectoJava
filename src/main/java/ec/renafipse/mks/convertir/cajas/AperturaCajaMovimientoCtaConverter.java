...
@ManagedBean
public class AperturaCajaMovimientoCtaConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof AperturaCajaMovimientoCta) {
            AperturaCajaMovimientoCta o = (AperturaCajaMovimientoCta) object;
            return getStringKey(o.getCodigoMovimiento());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), AperturaCajaMovimientoCta.class.getName()});
            return null;
        }
    }
