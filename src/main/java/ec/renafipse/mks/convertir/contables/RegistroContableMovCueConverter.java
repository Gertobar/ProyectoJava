...
@ManagedBean
public class RegistroContableMovCueConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof RegistroContableMovCue) {
            RegistroContableMovCue o = (RegistroContableMovCue) object;
            return getStringKey(o.getCodigoMovimiento());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), RegistroContableMovCue.class.getName()});
            return null;
        }
    }
