...
@ManagedBean
public class PlanDeCuentaConverter implements Converter {
    ...
    ec.renafipse.mks.modelo.contables.PlanDeCuentaPK getKey(String value) {
        ec.renafipse.mks.modelo.contables.PlanDeCuentaPK key;
        String values[] = value.split(SEPARATOR_ESCAPED);
        key = new ec.renafipse.mks.modelo.contables.PlanDeCuentaPK();
        key.setCuentaContable(values[0]);
        key.setCodigoTipoPlan(Long.parseLong(values[1]));
        return key;
    }

    String getStringKey(ec.renafipse.mks.modelo.contables.PlanDeCuentaPK value) {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof PlanDeCuenta) {
            ...
            return getStringKey(o.getPlanDeCuentaPK());
        } else {
