 ...
 */
package ec.mss.web.consumo.catalogo;
...
public class CatalogoServicio {
    ...
    private final String nombreServicio = "catalogo-servicio";
     ...
     * @return 
     */
    public RespuestaServicio catalogoAplicacion(){
        try{
            parametros = new HashMap<>();
            parametros.put("codigoIfip", ActivacionUsuario.getCodigoIfip());
           respuestaServicio = consumoServicioRecurso.consumoRecurso(nombreServicio, "catalogoIfip", parametros);
           return respuestaServicio;
        }catch(Exception ex){
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, CapturaError.errorNoCapturadoCapaDeControl,
                    new Object[]{"CatalogoServicio", "catalogoAplicacion", CapturaError.getErrorException(ex)});
