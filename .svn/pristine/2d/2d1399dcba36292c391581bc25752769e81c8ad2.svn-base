...
@ManagedBean
public class TransferenciaChequeDesgloceConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof TransferenciaChequeDesgloce) {
            TransferenciaChequeDesgloce o = (TransferenciaChequeDesgloce) object;
            return getStringKey(o.getCodigoCheque());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), TransferenciaChequeDesgloce.class.getName()});
            return null;
        }
    }
