...
@ManagedBean
public class PagoCreditoMovimientoCueConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof PagoCreditoMovimientoCue) {
            PagoCreditoMovimientoCue o = (PagoCreditoMovimientoCue) object;
            return getStringKey(o.getCodigoMovimiento());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), PagoCreditoMovimientoCue.class.getName()});
            return null;
        }
    }
