...
@ManagedBean(name = "balanceGeneralBean")
@ViewScoped
public class BalanceGeneralBean extends AbstractController<Comprobante> implements Serializable {
    ...
    public void init() {
        ...
        try {
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, CapturaError.errorNoCapturadoCapaDeControl,
                        new Object[]{"balanceGeneralBean", "init", CapturaError.getErrorException(ex)});
        }
    }
    ...
    public void iniciaParametros() throws ParseException {
        ...
        if (new Date().getYear() + 1900 == Integer.parseInt(periodoActual)) {
            ...
            this.fechaMaxima = convertirFecha("31/12/" + this.periodoActual);
        }
            ...
            if (Integer.parseInt(periodoActual) <= fechaHoy.getYear() + 1900) {
                ...
                if (Integer.parseInt(mesInicioActual) <= fechaHoy.getMonth() + 1) {
                    ...
                    msg = ResourceBundle.getBundle("/propiedadesEtiquetaEC").getString("Generar") + " "
                            + ResourceBundle.getBundle("/propiedadesEtiquetaEC").getString("BalanceGeneral");
                    exito = true;
                } else {
    ...
    public void exportarExcel(ActionEvent event) throws ParseException, IOException {
        ...
        String directoriReporte = "/contable/reportes/balanceGeneral/reporte/";
        ...
        getGeneraReporte().getParametros().put("subReporteBalanceGeneral", getGeneraReporte().getSubReporte(externalContext, directoriReporte, "balanceGeneralExcel"));

        System.out.println("fecha "+ ConvierteDato.getFechaCortaSinSeparadores(fechaCorte));
        String nombreArchivo = "BalanceGeneral-" + ConvierteDato.getFechaCortaSinSeparadores(fechaCorte);
        nombreReporte = "balanceGeneralXls";

        getGeneraReporte().exporta("/contable/reportes/balanceGeneral/reporte/", nombreReporte,
                nombreArchivo + ".xls",
