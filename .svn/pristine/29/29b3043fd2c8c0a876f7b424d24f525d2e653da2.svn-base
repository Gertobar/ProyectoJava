 ...
 */
@Embeddable
public class CierreAnualDetallePK implements Serializable {
    ...
    public CierreAnualDetallePK() {
    }

    public CierreAnualDetallePK(String codigoPeriodo, String cuentaContable, long codigoTipoPlan, long codigoIfip) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CierreAnualDetallePK)) {
            return false;
        }
        CierreAnualDetallePK other = (CierreAnualDetallePK) object;
    ...
    public String toString() {
        return "ec.renafipse.mks.modelo.contables.CierreAnualDetallePK[ codigoPeriodo=" + codigoPeriodo + ", cuentaContable=" + cuentaContable + ", codigoTipoPlan=" + codigoTipoPlan + ", codigoIfip=" + codigoIfip + " ]";
    }
