 ...
 */
@Embeddable
public class DocumentoRetencionPK implements Serializable {
    ...
    public DocumentoRetencionPK() {
    }

    public DocumentoRetencionPK(long codigoRetencion, long codigoDocumento) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DocumentoRetencionPK)) {
            return false;
        }
        DocumentoRetencionPK other = (DocumentoRetencionPK) object;
    ...
    public String toString() {
        return "ec.renafipse.mks.modelo.contables.DocumentoRetencionPK[ codigoRetencion=" + codigoRetencion + ", codigoDocumento=" + codigoDocumento + " ]";
    }
