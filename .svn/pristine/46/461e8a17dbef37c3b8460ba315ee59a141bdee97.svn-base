 ...
 */
public class PagoCreditoParcial {
    ...
    public PagoCreditoParcial( String mensajeFormulario, Long codigoFormulario, Long generaFormulario, Long codigoPagoCredito, Long codigoPagoAvanceLineaCredito ){
