...
@Named
public class SocioSituacionPatrimonialConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof SocioSituacionPatrimonial) {
            SocioSituacionPatrimonial o = (SocioSituacionPatrimonial) object;
            return getStringKey(o.getCodigoPersona());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), SocioSituacionPatrimonial.class.getName()});
            return null;
        }
    }
