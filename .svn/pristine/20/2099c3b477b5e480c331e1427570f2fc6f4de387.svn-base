 ...
 */
@Embeddable
public class RubroTablaAmortizacionPK implements Serializable {
    ...
    public RubroTablaAmortizacionPK() {
    }

    public RubroTablaAmortizacionPK(long numeroCredito, long codigoIfip, long cuota, long codigoRubro) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RubroTablaAmortizacionPK)) {
            return false;
        }
        RubroTablaAmortizacionPK other = (RubroTablaAmortizacionPK) object;
    ...
    public String toString() {
        return "ec.renafipse.mks.modelo.creditos.RubroTablaAmortizacionPK[ numeroCredito=" + numeroCredito + ", codigoIfip=" + codigoIfip + ", cuota=" + cuota + ", codigoRubro=" + codigoRubro + " ]";
    }
