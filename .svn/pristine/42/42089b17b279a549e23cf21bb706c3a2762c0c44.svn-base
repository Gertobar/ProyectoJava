...
public class CargoFacade extends AbstractFacade<Cargo> {
     ...
     * @return 
     */
    public List<Cargo> getItemsCargoEliminado(char eliminado)
    {
        return this.em.createNamedQuery(Cargo.findByEliminado).setParameter("eliminado", eliminado).getResultList();
    }
