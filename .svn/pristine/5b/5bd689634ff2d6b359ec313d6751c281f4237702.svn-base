...
@Named
public class PersonaInstitucionConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof PersonaInstitucion) {
            PersonaInstitucion o = (PersonaInstitucion) object;
            return getStringKey(o.getCodigoPersona());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), PersonaInstitucion.class.getName()});
            return null;
        }
    }
