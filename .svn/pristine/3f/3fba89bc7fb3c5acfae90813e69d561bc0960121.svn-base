...
import ec.renafipse.mks.negocio.creditos.SolicitudAprobadaPendienteDocumentoFacade;
...
@ManagedBean(name = "solicitudAprobadaPendienteDocumentoController")
@ViewScoped
public class solicitudAprobadaPendienteDocumentoController extends AbstractController<SolicitudAprobadoPenDoc> implements Serializable {

    @EJB
    private SolicitudAprobadaPendienteDocumentoFacade ejbFacade;
    ...
    public void init() {
        ...
        try {
            ...
            if(ejbFacadeFabricaUsuarioPerfil.validaAccesoProcesoCredito(ActivacionUsuario.getCodigoUsuario(), ActivacionUsuario.getCodigoIfipAgencia(), Long.parseLong("12"))){
                ...
                this.itemsSolicitud = this.ejbFacadeSolicitud.getItemsSolicitudCodigoIfipAllFabrica(ActivacionUsuario.getCodigoIfip(), Long.parseLong("12"),ActivacionUsuario.getCodigoUsuario());
            } else {
            ...
            try {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, CapturaError.errorNoCapturadoCapaDeControl,
                        new Object[]{"solicitudAprobadaPendienteDocumentoController", "solicitudAprobadaPendienteDocumentoController", CapturaError.getErrorException(ex)});
            }
        }
    }

    public solicitudAprobadaPendienteDocumentoController() {
    ...
    public void guardaAprobarNegarCredito() {
        ...
        try {
            ...
            // Registra el error en el log del servidor
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, CapturaError.errorNoCapturadoCapaDeControl,
                    new Object[]{"solicitudAprobadoPendienteDocumentoController", "guardaAprobarNegarCredito", CapturaError.getErrorException(ex)});
        }
    }
    ...
    public boolean aprobarNegarCredito() {
        if (this.itemsSolicitudSel != null) {
            ...
            for (Solicitud so : this.itemsSolicitudSel) {
                ...
                llamaSP.getListParametrosEntrada().add(new Object[]{"p_observaciones", so.getObservacionPendienteParaConceder()});
