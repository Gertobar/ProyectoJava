 ...
 */
@Embeddable
public class CierreDesgloceEfectivoPK implements Serializable {
    ...
    public CierreDesgloceEfectivoPK() {
    }

    public CierreDesgloceEfectivoPK(long codigoApertura, long codigoMoneda, long codigoTipoFraccion) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CierreDesgloceEfectivoPK)) {
            return false;
        }
        CierreDesgloceEfectivoPK other = (CierreDesgloceEfectivoPK) object;
    ...
    public String toString() {
        return "ec.renafipse.mks.modelo.cajas.CierreDesgloceEfectivoPK[ codigoApertura=" + codigoApertura + ", codigoMoneda=" + codigoMoneda + ", codigoTipoFraccion=" + codigoTipoFraccion + " ]";
    }
