...
@ManagedBean
public class UsuarioPuntoIfipCobroPagoConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof UsuarioPuntoIfipCobroPago) {
            UsuarioPuntoIfipCobroPago o = (UsuarioPuntoIfipCobroPago) object;
            return getStringKey(o.getCodigoUsuario());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), UsuarioPuntoIfipCobroPago.class.getName()});
            return null;
        }
    }
